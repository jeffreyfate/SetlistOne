...
public class SetlistOneSuite {

    protected static Object test;
    protected static int failures = 0;
    
    public static final String MAIN_CLASS = "com.jeffthefate.dmb.setlist.test.Test";

    public static void main(String args[]) {
        new TestSuite(SetlistOneSuite.class).run(new TestResult());
    }
